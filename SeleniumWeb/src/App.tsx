  ...
  return (
    <div className="bg-black text-white">
      <header className="fixed inset-x-0 top-0 z-30 border-b border-white/10 bg-black/70 backdrop-blur-md">
        <nav className="mx-auto flex h-16 w-full max-w-6xl items-center px-6 lg:px-10">
      ...
      <main id="top">
        <section className="relative min-h-screen overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(239,68,68,0.2),transparent_35%),radial-gradient(circle_at_80%_30%,rgba(249,115,22,0.2),transparent_40%),linear-gradient(to_bottom,rgba(0,0,0,0.8),rgba(0,0,0,0.95))]" />
          ...
          <div className="relative mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center px-6 pt-24 pb-16 lg:px-10">
            <div className="max-w-5xl space-y-8 text-center">
              ...
              >
                <a
                  href="#products"
                  className="rounded-md bg-gradient-to-r from-red-500 to-orange-400 px-6 py-3 text-sm font-bold uppercase tracking-wider text-black transition hover:brightness-110"
                >
                  Products
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-md border border-white/40 px-6 py-3 text-sm font-bold uppercase tracking-wider text-white transition hover:border-orange-300 hover:text-orange-200"
                >
                  Join Discord
                </a>
              </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-md border border-white/40 px-8 py-3 text-sm font-bold uppercase tracking-wider text-white transition hover:border-orange-300 hover:text-orange-200"
              >
                Executor
              </a>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-md bg-gradient-to-r from-orange-400 to-red-500 px-8 py-3 text-sm font-bold uppercase tracking-wider text-black transition hover:brightness-110"
              >
                Purchase
              </a>
            </div>
