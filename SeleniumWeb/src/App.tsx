...
const TOS_TEXT = `# Selenium Terms of Service

**Effective Date:** January 1, 2026

By downloading, accessing, or using Selenium ("Service", "Software"), you agree to these Terms of Service. If you do not agree, you must stop using the Service immediately.
...
**"Selenium" / "we" / "us"**
Refers to the Selenium exploit, website, loader, APIs, Discord services, and related systems.

**"User" / "you"**
Any person using Selenium.

**"Software"**
Any executable, loader, script, API, or file distributed by Selenium.
...
You are responsible for your account and any activity that occurs under it.
...
* Use stolen or unauthorized accounts
...
Official support is provided only through Selenium's official channels.`;
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="mx-auto max-w-4xl px-6 pt-28 pb-16 lg:px-10">
        <motion.pre
          ...
          className="whitespace-pre-wrap font-sans text-zinc-300"
        >
          {TOS_TEXT}
        </motion.pre>
      </main>
